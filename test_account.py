...
class Test: 
    ...
    def test_deposit(self):    
        ...
        assert self.p1.get_balance() == approx(1.0, abs=abs)
        assert self.p1.deposit(1) == True
        assert self.p1.get_balance() == approx(2.0, abs=abs)
        ...
        assert self.p2.get_balance() == approx(1.0, abs=abs)
        assert self.p2.deposit(1) == True
        assert self.p2.get_balance() == approx(2.0, abs=abs)
    ...
    def test_withdrawl(self):
        ...
        assert self.p1.withdrawl(9.5) is True
        assert self.p1.get_balance() == approx(0.5, abs=abs)
        ...
        assert self.p2.withdrawl(9.5) is True
        assert self.p2.get_balance() == approx(0.5, abs=abs)
